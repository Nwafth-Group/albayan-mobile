...
class ApiConstants {
  ...
  static const String verifyForgotPasswordOtp =
      '/reader/auth/verify-forgot-password-otp';
...
class AppStrings {
  ...
  static const String validationFirstNameRequired =
      'validation_first_name_required';
  static const String validationLastNameRequired =
  ...
  static const String noIssuesAvailable =
      'no_issues_available'; // "No Issues Available for {year}"
  ...
  static const String basedOnRatings =
  ...
  static const String collectionsCount =
  ...
  static const String publisherHouse = 'publisher_house';
  static const String aboutPublisherHouse = 'about_publisher_house';
  static const String discoverBooksTitle = 'discover_books_title';
  ...
  static const String libraryTabMyLibrary = 'library_tab_my_library';
  static const String libraryTabCategories = 'library_tab_categories';
  static const String libraryTabFavorites = 'library_tab_favorites';
  static const String libraryBooks = 'library_books';
  static const String libraryMyDocuments = 'library_my_documents';
  static const String libraryAlbayanMagazine = 'library_albayan_magazine';
  static const String libraryBooksCount =
      'library_books_count'; // "{count} Book"
  static const String libraryDocumentsCount =
      'library_documents_count'; // "{count} Documents"
  static const String libraryItemsCount =
      'library_items_count'; // "{count} Items"
  static const String libraryNoCategories = 'library_no_categories';
  static const String libraryNoFavorites = 'library_no_favorites';
  static const String libraryNoItems = 'library_no_items';
  static const String libraryMagazineIssuesTab = 'library_magazine_issues_tab';
  static const String libraryMagazineArticlesTab =
      'library_magazine_articles_tab';
  static const String libraryIssuesCount =
      'library_issues_count'; // "{count} Issues"
  static const String libraryArticlesCount =
      'library_articles_count'; // "{count} Articles"
  static const String libraryNoDocuments = 'library_no_documents';
  static const String libraryAddDocumentsTitle = 'library_add_documents_title';
  static const String libraryChooseFromPhone = 'library_choose_from_phone';
