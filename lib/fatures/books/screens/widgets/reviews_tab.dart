...
// ============================================
// FILE: lib/fatures/books/screens/widgets/reviews_tab.dart
// ============================================
        ...
        children: [
          ...
          Row(
            children: [
              ...
              StarRow(rating: book.rate, size: 20),
            ],
          ),
          const SizedBox(height: 2),
          Text(
            AppStrings.basedOnRatings.tr(
              namedArgs: {'count': book.rateCount.toString()},
            ),
            style: const TextStyle(
          ...
          // Review list
          for (final c in comments) BookReviewCard(comment: c),
